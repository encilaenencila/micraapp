...
import com.example.micraapp.databinding.ActivityCrime3Binding;
...
public class CrimeActivity3 extends drawerbase  {
    ActivityCrime3Binding activityCrime3Binding;
    ...
    TextView tvcomplainant,tvgelocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crime3);
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        activityCrime3Binding = activityCrime3Binding.inflate(getLayoutInflater());
        allocateActivitytitle("CrimeActivity3");
        setContentView(activityCrime3Binding.getRoot());
        ...
        tefirstname.setFilters(new InputFilter[]{filter, new InputFilter.LengthFilter(16)});
        telastname.setFilters(new InputFilter[]{filter, new InputFilter.LengthFilter(16)});
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (haserror == false && haserror2 == false && haserror3 == false && haserror4 == false && haserror5 == false && haserror6 == false && haserror7 == false) {
                    ...
                    Intent intent = new Intent(CrimeActivity3.this, CrimeActivity4.class);
                    if(bitmap != null){
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_ID_MULTIPLE_PERMISSIONS && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                bitmap = MediaStore.Images.Media.getBitmap(CrimeActivity3.this.getContentResolver(), path);
                ...
                mFusedLocationClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(Task<Location> task) {
                        ...
                        if (location == null) {
                            ...
                            geocoder = new Geocoder(CrimeActivity3.this, Locale.getDefault());
    ...
    private boolean isValidHouseNo(CharSequence phoneNumber) {
        ...
        Matcher matcher = Pattern.compile("(^(?![0]*$)\\d{1,4}(?:\\d{1,2})?$)").matcher(phoneNumber);
        return matcher.matches();
    }
    ...
    public static boolean isValidNameFormat(String Nameformat) {
        Matcher matcher = Pattern.compile("^(?!.*[ ]{2})[abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ]*").matcher(Nameformat);
        return matcher.matches();
    ...
    public static boolean isValidAddress(String Nameformat) {
        Matcher matcher = Pattern.compile("\\d{1,5}\\s\\w.\\s(\\b\\w*\\b\\s){1,2}\\w*\\.").matcher(Nameformat);
        return matcher.matches();
    ...
    public void onBackPressed() {
        ...
        if (true) {
            ...
            new android.app.AlertDialog.Builder(CrimeActivity3.this)
