...
public class InfraActivity extends drawerbase  {
    ActivityInfraBinding activityInfraBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityInfraBinding = activityInfraBinding.inflate(getLayoutInflater());
        allocateActivitytitle("InfraActivity");

        setContentView(activityInfraBinding.getRoot());
     ...
     /*   if(!C1.contains(c1_comAge)){
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(InfraActivity.this, "As proof, please attach an image!", Toast.LENGTH_SHORT).show();
                    haserror7 = true;
                }
                else {
                    haserror7 = false;
                ...
                if (haserror == false && haserror2 == false && haserror3 == false && haserror4 == false && haserror5 == false  && haserror6 == false &&  haserror7 == false ) {
                    ...
                    Intent intent = new Intent(InfraActivity.this, InfraActivity2.class);
                    if(bitmap != null){
                    ...
                    intent.putExtra("address", tehouseno.getText().toString().trim() + " " + testreet.getText().toString().trim() + " " + "Masambong Q.C.");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_ID_MULTIPLE_PERMISSIONS && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                bitmap = MediaStore.Images.Media.getBitmap(InfraActivity.this.getContentResolver(), path);
                ...
                mFusedLocationClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(Task<Location> task) {
                        ...
                        if (location == null) {
                            ...
                            geocoder = new Geocoder(InfraActivity.this, Locale.getDefault());
    ...
    public void onBackPressed() {
        ...
        if (true) {
            ...
            new android.app.AlertDialog.Builder(InfraActivity.this)
