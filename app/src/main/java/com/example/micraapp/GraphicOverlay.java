...
public class GraphicOverlay extends View {  private static final String TAG = "MainActivity";
    ...
    public void onDraw(Canvas canvas) {
        ...
        if(name != null && !name.trim().isEmpty() && rectF != null && !name.equals("unknown")) {
            ...
            labelPaint.setColor(Color.parseColor("#00000000"));
            ...
            rectPaint.setColor(Color.parseColor("#00000000"));
        } else {
            rectPaint.setColor(Color.parseColor("#00000000"));
    ...
    private RectF adjustBoundingRect(Rect rect) {
        if(rect != null) {
            ...
            return new RectF(
                    ...
                    translateX((float) rect.right) + 50.0f,
