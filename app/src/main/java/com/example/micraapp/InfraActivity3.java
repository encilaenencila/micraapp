...
public class InfraActivity3 extends drawerbase {
    ActivityInfra3Binding activityInfra3Binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityInfra3Binding = activityInfra3Binding.inflate(getLayoutInflater());
        allocateActivitytitle("InfraActivity3");
        setContentView(activityInfra3Binding.getRoot());
...
*/
       ...
       /* if(!C1.contains(c1_comAge)){
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(InfraActivity3.this, "As proof, please attach an image!", Toast.LENGTH_SHORT).show();
                    haserror6 = true;
                }
                else {
                    haserror6 = false;
                ...
                if (haserror == false && haserror2 == false && haserror3 == false && haserror4 == false && haserror5 == false && haserror6 == false) {
                    ...
                    Intent intent = new Intent(InfraActivity3.this, InfraActivity4.class);
                    if (bitmap != null) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_ID_MULTIPLE_PERMISSIONS && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                bitmap = MediaStore.Images.Media.getBitmap(InfraActivity3.this.getContentResolver(), path);
                ...
                mFusedLocationClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(Task<Location> task) {
                        ...
                        if (location == null) {
                            ...
                            geocoder = new Geocoder(InfraActivity3.this, Locale.getDefault());
    ...
    public void onBackPressed() {
        ...
        if (true) {
            ...
            new android.app.AlertDialog.Builder(InfraActivity3.this)
