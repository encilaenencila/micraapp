...
public class WasteActivity extends drawerbase {
    ActivityWasteBinding activityWasteBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityWasteBinding = activityWasteBinding.inflate(getLayoutInflater());
        allocateActivitytitle("WasteActivity");
        setContentView(activityWasteBinding.getRoot());
       ...
       /* if (!C1.contains(c1_comAge)) {
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(WasteActivity.this, "As proof, please attach an image!", Toast.LENGTH_SHORT).show();
                    haserror7 = true;
                }
                else
                { haserror7 = false;
                ...
                if (haserror == false && haserror2 == false && haserror3 == false && haserror4 == false && haserror5 == false && haserror6 == false && haserror7 == false) {
                    ...
                    Intent intent = new Intent(WasteActivity.this, WasteActivity2.class);
                    if (bitmap != null) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_ID_MULTIPLE_PERMISSIONS && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                bitmap = MediaStore.Images.Media.getBitmap(WasteActivity.this.getContentResolver(), path);
                ...
                mFusedLocationClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(Task<Location> task) {
                        ...
                        if (location == null) {
                            ...
                            geocoder = new Geocoder(WasteActivity.this, Locale.getDefault());
    ...
    public void onBackPressed() {
        ...
        if (true) {
            ...
            new android.app.AlertDialog.Builder(WasteActivity.this)
